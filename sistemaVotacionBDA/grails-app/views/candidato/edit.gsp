...
<html>
    ...
    <body>
        ...
        <div id="edit-candidato" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.candidato}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.candidato}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.candidato}" method="PUT">
                <g:hiddenField name="version" value="${this.candidato?.version}" />
                <fieldset class="form">
                    <f:all bean="candidato"/>
                </fieldset>
