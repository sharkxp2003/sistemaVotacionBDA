...
<html>
    ...
    <body>
        ...
        <div id="show-candidato" class="content scaffold-show" role="main">
            ...
            <f:display bean="candidato" />
            <g:form resource="${this.candidato}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.candidato}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
